...
export declare function getUserOperationStatus<TAccount extends SmartAccount | undefined>(client: Client<Transport, Chain | undefined, Account | undefined, MiscRpcSchema>, parameters: GetUserOperationStatusParameters & {
    account?: TAccount;
