import type { Abi, Chain, Client, ContractFunctionArgs, ContractFunctionName, Hash, Transport, TypedData, WaitForTransactionReceiptParameters, WaitForTransactionReceiptReturnType, WriteContractParameters } from "viem";
import type { PrepareUserOperationParameters, SmartAccount, UserOperation } from "viem/account-abstraction";
import type { CallDictionary } from "../erc7579";
import { type DebugUserOperationReturnType } from "./debugUserOperation";
import type { DebugUserOperationParameters } from "./debugUserOperation";
import { type PrepareTokenPaymasterUserOpParameters } from "./prepareTokenPaymasterUserOp";
import { prepareUserOperationWithoutSignature } from "./prepareUserOperationWithoutSignature";
import { type SendTokenPaymasterUserOpParameters } from "./sendTokenPaymasterUserOp";
import { sendTransaction } from "./sendTransaction";
import { signMessage } from "./signMessage";
import { signTypedData } from "./signTypedData";
import { type UpgradeSmartAccountParameters } from "./upgradeSmartAccount";
...
export type SmartAccountActions<TChain extends Chain | undefined = Chain | undefined, TSmartAccount extends SmartAccount | undefined = SmartAccount | undefined> = {
     ...
     */
    prepareTokenPaymasterUserOp: (args: PrepareTokenPaymasterUserOpParameters) => Promise<Omit<UserOperation, "signature">>;
    /**
    ...
    waitForTransactionReceipt: (params: WaitForTransactionReceiptParameters) => Promise<WaitForTransactionReceiptReturnType>;
    /**
     ...
     * })
     */
    prepareUserOperation: (params: PrepareUserOperationParameters) => Promise<ReturnType<typeof prepareUserOperationWithoutSignature>>;
    /**
...
export declare const smartAccountCalls: CallDictionary;
