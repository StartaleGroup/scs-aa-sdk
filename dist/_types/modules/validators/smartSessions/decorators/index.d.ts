...
import { type GrantPermissionParameters, type GrantPermissionResponse, grantPermission } from "./grantPermission";
 ...
 */
export type SmartSessionActions<TModularSmartAccount extends ModularSmartAccount | undefined> = {
    /**
 ...
 */
export declare function smartSessionActions(): <TModularSmartAccount extends ModularSmartAccount | undefined>(client: Client<Transport, Chain | undefined, TModularSmartAccount>) => SmartSessionActions<TModularSmartAccount>;
