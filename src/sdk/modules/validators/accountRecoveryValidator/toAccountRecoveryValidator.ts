...
import { getSmartSessionsValidator, getSocialRecoveryMockSignature, SMART_SESSIONS_ADDRESS, SOCIAL_RECOVERY_ADDRESS } from "@rhinestone/module-sdk"

// WIP
// only makes sense in the case of single guardian right now
...
export type AccountRecoveryModuleData = {
    guardians: Address[]
    threshold: number
}

export type AccountRecoveryModule = Module & {
  moduleData?: AccountRecoveryModuleData
}
 ...
 */
export type AccountRecoveryModuleParameters = Omit<
  ModuleParameters,
  "accountAddress" | "address"
> & {
  account: ModularSmartAccount
  moduleData?: RecoveryModuleData
}
 ...
 */
export const toAccountRecoveryValidator = (
  parameters: AccountRecoveryModuleParameters
): AccountRecoveryModule => {
  const {
    account,
    signer, // could be multiple guardians and they all need to sign
